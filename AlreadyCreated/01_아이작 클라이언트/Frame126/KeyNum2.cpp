...
void CKeyNum2::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CKeyNum2::Render(HDC hDC)
{
...
void CKeyNum2::Release(void)
{

}

void CKeyNum2::Motion_Change(void)
{
...
void CKeyNum2::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/UI/Number1.bmp", L"Number");

}

void CKeyNum2::First_State(void)
{
