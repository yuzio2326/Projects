...
void CHeart2::Initialize(void)
{
	m_tInfo.fX = 96.f;		// 중점 X
...
int CHeart2::Update(void)
{
	if (m_iMaxHP <= 4||m_iHP<=0)
		m_bDead = true;
...
void CHeart2::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CHeart2::Render(HDC hDC)
{
...
void CHeart2::Motion_Change(void)
{
