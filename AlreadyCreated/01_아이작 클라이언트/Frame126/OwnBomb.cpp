...
void COwnBomb::Initialize(void)
{
	m_tInfo.fX = 16.f;		// 중점 X
	m_tInfo.fY = 192.f;		// 중점 Y
...
void COwnBomb::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void COwnBomb::Render(HDC hDC)
{
...
void COwnBomb::Release(void)
{

}

void COwnBomb::Motion_Change(void)
{
