...
void CPickupHeart2::Initialize(void)
{
...
int CPickupHeart2::Update(void)
{

	if (true == m_bDead)
	{
		CObjMgr::Get_Instance()->Get_Player()->Set_HP(8);
		return OBJ_DEAD;
	}
...
void CPickupHeart2::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CPickupHeart2::Render(HDC hDC)
{
...
void CPickupHeart2::Release(void)
{

}

void CPickupHeart2::Motion_Change(void)
{

}

void CPickupHeart2::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Item/pickup_001_heart.bmp", L"PickupHeart");

}

void CPickupHeart2::First_State(void)
{
