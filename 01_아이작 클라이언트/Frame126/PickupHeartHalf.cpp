...
CPickupHeartHalf::CPickupHeartHalf()
{
}
...
void CPickupHeartHalf::Initialize(void)
{
...
int CPickupHeartHalf::Update(void)
{

	if (true == m_bDead)
	{
		CObjMgr::Get_Instance()->Get_Player()->Set_HP(2);
		return OBJ_DEAD;
	}
...
void CPickupHeartHalf::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CPickupHeartHalf::Render(HDC hDC)
{
...
void CPickupHeartHalf::Release(void)
{

}

void CPickupHeartHalf::Motion_Change(void)
{

}

void CPickupHeartHalf::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Item/pickup_001_heart.bmp", L"PickupHeart");

}

void CPickupHeartHalf::First_State(void)
{
