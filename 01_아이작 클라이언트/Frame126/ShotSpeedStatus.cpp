#include "stdafx.h"
#include "ShotSpeedStatus.h"
#include "ObjMgr.h"
#include "BmpMgr.h"
#include "KeyMgr.h"
#include "ScrollMgr.h"
#include "Player.h"
CShotSpeedStatus::CShotSpeedStatus()
{
}
...
void CShotSpeedStatus::Initialize(void)
{
	m_tInfo.fX = 16.f;		// 중점 X
	m_tInfo.fY = 335.f;		// 중점 Y
...
int CShotSpeedStatus::Update(void)
{
...
void CShotSpeedStatus::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CShotSpeedStatus::Render(HDC hDC)
{
...
void CShotSpeedStatus::Release(void)
{

}

void CShotSpeedStatus::Motion_Change(void)
{

}

void CShotSpeedStatus::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/UI/hudstats.bmp", L"Status");

}

void CShotSpeedStatus::First_State(void)
{
