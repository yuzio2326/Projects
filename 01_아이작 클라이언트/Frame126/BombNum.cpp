...
void CBombNum::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CBombNum::Render(HDC hDC)
{
...
void CBombNum::Release(void)
{

}

void CBombNum::Motion_Change(void)
{
...
void CBombNum::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/UI/Number1.bmp", L"Number");

}

void CBombNum::First_State(void)
{
