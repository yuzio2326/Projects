...
void CHeart4::Initialize(void)
{
	m_tInfo.fX = 160.f;		// 중점 X
...
int CHeart4::Update(void)
{
	if (m_iMaxHP <= 12||m_iHP<=0)
		m_bDead = true;
...
void CHeart4::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CHeart4::Render(HDC hDC)
{
...
void CHeart4::Release(void)
{

}

void CHeart4::Motion_Change(void)
{
