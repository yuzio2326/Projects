...
void CPrismItem::Initialize(void)
{
	...
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Item/collectibles_528_angelic prism.bmp", L"PrismItem");
...
void CPrismItem::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CPrismItem::Render(HDC hDC)
{
	HDC hMemDC = CBmpMgr::Get_Instance()->Find_Image(L"PrismItem");
...
void CPrismItem::Release(void)
{

}

void CPrismItem::Motion_Change(void)
{

}

void CPrismItem::Insert_Texture(void)
{
}

void CPrismItem::First_State(void)
{
}
