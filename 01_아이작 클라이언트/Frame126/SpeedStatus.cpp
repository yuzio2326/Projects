...
void CSpeedStatus::Initialize(void)
{
	m_tInfo.fX = 16.f;		// 중점 X
	m_tInfo.fY = 270.f;		// 중점 Y
...
void CSpeedStatus::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CSpeedStatus::Render(HDC hDC)
{
...
void CSpeedStatus::Release(void)
{

}

void CSpeedStatus::Motion_Change(void)
{

}

void CSpeedStatus::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/UI/hudstats.bmp", L"Status");

}

void CSpeedStatus::First_State(void)
{
