...
void CCoinNum2::Initialize(void)
{
...
void CCoinNum2::Late_Update(void)
{
	if (CKeyMgr::Get_Instance()->Key_Pressing('Q'))
		m_fAngle += 45.f;
}

void CCoinNum2::Render(HDC hDC)
{
...
void CCoinNum2::Release(void)
{

}

void CCoinNum2::Motion_Change(void)
{
...
void CCoinNum2::Insert_Texture(void)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/UI/Number1.bmp", L"Number");

}

void CCoinNum2::First_State(void)
{
